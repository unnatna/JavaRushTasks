...
public class Solution {
    ...
    public static void printMatrix(long m, long n, int value) {
        System.out.println("Заполняем объектами Integer");
    ...
    public static void printMatrix(long m, long n, double value) {
        System.out.println("Заполняем объектами Integer");
        printMatrix((int)m, (int)n, (Object) value);
    }

    public static void printMatrix(long m, long n, short value) {
        System.out.println("Заполняем объектами Integer");
        printMatrix((int)m, (int)n, (Object) value);
    }

    public static void printMatrix(long m, long n, float value) {
        System.out.println("Заполняем объектами Integer");
        printMatrix((int)m, (int)n, (Object) value);
    }
